...
!function ($) {
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            {
                html += '<th class="prev available"><i class="glyphicon glyphicon-arrow-left icon-arrow-left"></i></th>';
            }
            else
            {
                 html += '<th></th>';
            ...
            {
                html += '<th class="next available"><i class="glyphicon glyphicon-arrow-right icon-arrow-right"></i></th>';
            }
            else
            {
                 html += '<th></th>';
